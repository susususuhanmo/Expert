...
object getData {
  ...
  def getFullDataCNKIsql(hiveContext: HiveContext,removePostCode:RemovePostCode) = {
    ...
    hiveContext.udf.register("getFirstInstitute", (str: String) => if (str != "" && str != null) getFirstLevelOrgan.getFirstLevelOrgan(cnkiOps.getFirstInstitute(str)) else null)
  ...
  def getFullDataVIPsql(hiveContext: HiveContext,removePostCode:RemovePostCode) = {
  ...
  def getFullDataWFsql(hiveContext: HiveContext,removePostCode:RemovePostCode) = {
...
def getPostArray(hiveContext: HiveContext): Array[String] ={
  ReadData.readDataLog("t_pCOde",hiveContext).map(row => row.getString(row.fieldIndex("pCode"))).collect()
}
  ...
  def getForSplitRdd(data: DataFrame,removePostCode: RemovePostCode): RDD[(String, ((String, String), (String, String, String, String, String)))] = {
    ...
    data
      .map(r => (
        getRowString(r, "id"),
        ((cleanKeyword(getRowString(r, "creatorAll")), cnkiOps.cleanInstitute(cleanKeyword(getRowString(r, "instituteAll")),removePostCode)),
